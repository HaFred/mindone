...
def sample(
        input_path: str = "data/test_image.png",
        ckpt_path: str = "../sv3d/ckpt/sv3d_u.ckpt",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt', default='../sv3d/ckpt/sv3d_u.ckpt', type=str, help='path to the ckpt')
